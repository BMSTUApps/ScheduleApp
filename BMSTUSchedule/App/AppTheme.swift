...
class AppTheme {
    ...
    class AppColor {
        ...
        static let lightGray = UIColor(red: 137/255, green: 161/255, blue: 175/255, alpha: 1)
        static let midLightGray = UIColor(red: 143/255, green: 142/255, blue: 148/255, alpha: 0.5)
    ...
    let lightGrayColor = AppColor.lightGray
    ...
    let tableSeparatorColor = AppColor.midLightGray
}
